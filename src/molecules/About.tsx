                ...
                <div className=' relative py-10 bg-green-300 lg:ms-10 ms-8 after:content-[""] after:block after:h-full after:w-full after:border-4 after:border-green-500 after:absolute after:start-[-30px] after:z-[-3] after:top-8'>
                  ...
                  <div className={`${pivisiblity ? "block" : "hidden"} absolute bg-[rgb(0_0_0/88%)] h-full w-full top-0 p-6 text-[white]`}>
                    ...
                    <div className='flex space-x-2 text-base'>
                      <Link href={""} title='' className='p-2 bg-blue-400 hover:bg-green-500 '><FaXTwitter /></Link>
                      <Link href={""} title='' className='p-2 bg-blue-400 hover:bg-green-500 '><FaWhatsapp /></Link>
                      <Link href={""} title='' className='p-2 bg-blue-400 hover:bg-green-500 '><FaFacebookF /></Link>
                      <Link href={""} title='' className='p-2 bg-blue-400 hover:bg-green-500 '><FaInstagram /></Link>
                      <Link href={""} title='' className='p-2 bg-blue-400 hover:bg-green-500 '><FaLinkedinIn /></Link>
                    </div>
                  </div>
